...
if __name__ == '__main__':
    ...
    dataset2prompt = json.load(open("Eval/config/dataset2prompt.json", "r",encoding='utf-8'))
    ...
    pred_model = internlm2Chat(model2path[model_name], model_name, adapter2path[model_name])
